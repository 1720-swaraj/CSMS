...
import { getManufac, getModelById, getOutlets, getServices } from './services/user'
...
export default function ServicesPage() {
  ...
  //     id: 1,
  //     name: 'Oil Change',
  //     description: 'Description of Oil Change',
  //     price: 50,
  //   },
  //   {
  //     id: 2,
  //     name: 'Tire Change',
  //     description: 'Description of Tire Change',
  //     price: 80,
  //   },
  //   {
  //     id: 3,
  //     name: 'Engine Repair',
  //     description: 'Description of Engine Repair',
  //     price: 120,
  //   },
  //   {
  //     id: 4,
  //     name: 'Head Light Change',
  //     description: 'Description of Head Light Change',
  //     price: 40,
  //   },
  // ];
